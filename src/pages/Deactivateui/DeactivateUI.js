      ...
      <Dialog as="div" className="relative z-10" onClose={setOpen}>
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0 w-full ">
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg w-full bg-white   pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg ">
