...
import { SectionNavigationdata } from '@/components/Seed/Gamesummarydata'
...
export default function GamesummaryUItabs({SectionNavigation=SectionNavigationdata,activatedtab}) {
