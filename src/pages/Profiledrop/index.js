                  ...
                  >
                    <Menu.Items className="absolute -right-4 z-10 mt-6 w-60 origin-top-right rounded-lg bg-white py-1 shadow-lg  shadow-gray-400 ring-1 ring-black ring-opacity-5 focus:outline-none">
                        ...
                        {({ active }) => (
                          <a
                            href="#"
                            className={classNames(active ? 'bg-gray-100' : '', 'block px-4 py-1 text-sm text-gray-800 font-semibold')}
                          >
                            James Chapperro
                          </a>
                        )}
                      ...
                      <Menu.Item>
                        {({ active }) => (
                          <a
                            href="#"
                            className={classNames(active ? 'bg-gray-100' : '', 'block px-4  text-xs text-gray-700')}
                          >
                            @jameschappero
                          </a>
                        )}
                        ...
                        {({ active }) => (
                          <a
                            href="#"
                            className={classNames(active ? 'bg-gray-100' : '', 'block px-4 py-1 text-sm text-gray-800 ')}
                          >
                            Do not disturn mode
                          </a>
                        )}
                      ...
                      <Menu.Item>
                        {({ active }) => (
                          <a
                            href="#"
                            className={classNames(active ? 'bg-gray-100' : '', 'block px-4 py-1  text-sm text-gray-700')}
                          >
                           set a status
                          </a>
                        )}
